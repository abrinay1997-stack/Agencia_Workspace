...
LA REGLA DE CONTRASTE QUE NO SE ROMPE
  ...
  EL AMARILLO #FED00F JAMÁS TOCA EL BLANCO NI EL HUESO. El contraste es de
  1.47:1 y el texto desaparece. El amarillo solo lleva texto AZUL #1340B1
  encima, y solo se apoya sobre azul, sobre foto oscurecida o sobre sí mismo.

  Combinaciones permitidas:
    blanco sobre azul     ✅   azul sobre blanco    ✅
    azul sobre amarillo   ✅   amarillo sobre azul  ✅
    amarillo sobre blanco ❌   amarillo sobre hueso ❌
...
FUENTES. Cárgalas desde Google Fonts en el <head>:
...
No incluyas nada de esto en ninguna imagen:
  ...
  salvia, beige premium, tonos tierra apagados, gris frío, azul grisáceo
...
HASHTAGS:
#OrganizaTuCasa #MueblesPanamá #DcasaPanamá #LaChorrera #PanamáOeste
#TuCasaBienAmueblada
...
LISTA:
  — El par más alto que tengas. Las botas mandan sobre el alto de cada nivel.
  — La pared libre donde va a ir, no el pasillo completo.
  — Si la puerta abre justo encima de ese espacio.
...
HASHTAGS:
#TipsDeHogar #OrganizaTuCasa #DcasaPanamá #MueblesPanamá #LaChorrera
#PanamáOeste
...
HASHTAGS:
#Zapateras #MueblesPanamá #DcasaPanamá #OrganizaTuCasa #LaChorrera
#PanamáOeste
...
seleccionable):
  0-3 s   Plano de la pared vacía junto a la puerta. "¿Dónde la pongo?"
  3-9 s   Sitio 1: detrás de la puerta, si la puerta no abre hasta el fondo.
          — plano de la puerta abriendo.
  9-15 s  Sitio 2: la pared del pasillo, si te queda medio metro libre.
          — plano del pasillo.
  15-21 s Sitio 3: dentro del clóset, abajo, si prefieres no verla.
