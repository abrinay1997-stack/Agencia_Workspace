...
| `Baby Caleb/` | Baby Caleb Panamá (pañales/wipes hipoalergénicos Nateen + fulares Moon) | ✅ Identidad verificada por el cliente (onboarding 2026-08). **Discrepancias resueltas:** color oscuro = Navy Ink `#1B3246`; tipografía = Montserrat (sin Playfair). Web propia [babycaleb.netlify.app](https://babycaleb.netlify.app). Fe = valor silencioso confirmado. Precios y tallas verificados (tabla de `01_brand_guidelines.md` §4 = única fuente de precios). Web alineada con el ADN el 2026-08-10: sin punto físico (venta 100% online), sin versículos, tallas RN a XXL. **Ficha de negocio** (contacto, precios, tallas y lo que no se dice) en `01_ADN_y_Memoria/06_ficha_negocio.json`, 2026-08-28 |
